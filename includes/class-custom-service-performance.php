...
class CustomServicePerformance
{
    ...
    public function enqueue_admin_scripts()
    {
        ...
        if ($screen->id === 'csp_service') {
            ...
            $script_path = $base_path . 'assets/js/csp-script.js';
            $script_version = filemtime($script_path);

            $script_url = plugins_url('assets/js/csp-script.js', $base_path . 'custom-service-performance.php');
            ...
            $style_url = plugins_url('assets/css/csp-admin-styles.css', $base_path . 'custom-service-performance.php');
            $style_version = filemtime($style_url);
    ...
    public function meta_box_html($post){
        echo "<div class='service-meta-box-container'>";
        ...
        echo "<textarea
              ...
              >";
        echo esc_textarea($service_description);
        echo "</textarea>";
        echo "</div>";
